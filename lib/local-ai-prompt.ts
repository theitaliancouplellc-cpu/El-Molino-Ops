...
export function buildLocalAIMessages(input:{question:string;history?:LocalHistoryMessage[];knowledge?:LocalKnowledge[];procedures?:LocalProcedure[];liveContext?:{weather?:string}}):LocalAIMessage[]{
