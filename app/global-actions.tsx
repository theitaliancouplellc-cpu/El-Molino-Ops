...
import { CalendarDays, Camera, ClipboardCheck, FileText, FolderOpen, Menu as MenuIcon, Search, Settings, Star, Users, Wrench, X, Zap } from 'lucide-react';
...
const commands:Command[]=[
  ...
  {title:'Files & Media',subtitle:'Private photos, documents, video and voice',href:'/files',keywords:'files photos documents video voice attachments',icon:FolderOpen},
  {title:'Saved & Recent',subtitle:'Bookmarked and recently opened work',href:'/saved',keywords:'saved favorites bookmarks recent history',icon:Star},
...
const stableResultHref=(r:Result)=>r.entity_type==='ops_record'?`/ops-record/${r.entity_id}`:r.href||'/';
