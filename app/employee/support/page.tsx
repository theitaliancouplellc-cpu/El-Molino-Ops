...
export default function EmployeeSupportPage(){
 ...
 async function submit(e:FormEvent){
  ...
  pending.current=null;setCategory('app_error');setSummary('');setDescription('');await load();setMessage(c.sent);setBusy(false)
 }
