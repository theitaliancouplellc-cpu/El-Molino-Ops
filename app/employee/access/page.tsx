...
export default function EmployeeAccess(){
 ...
 const c=locale==='es'?{verifyError:'No se pudo verificar tu acceso de personal.',checking:'Verificando acceso del personal…',staff:'Personal de El Molino',title:'Acceso a la Cuenta',suspended:'Acceso suspendido',inactive:'Cuenta inactiva',suspendedHeading:'Tu acceso de personal está suspendido temporalmente.',inactiveHeading:'Tu cuenta de personal no está activa.',questions:'Habla con un gerente si tienes preguntas sobre tu estado laboral actual.',meaning:'Qué significa esto',suspendedBody:'Tu perfil e historial de empleado permanecen intactos, pero las herramientas de horario, Bolsa de Turnos, equipo, reloj, capacitación y propinas no están disponibles hasta que gerencia restablezca el acceso.',inactiveBody:'Tu perfil de empleado sigue vinculado para mantener registros, pero las herramientas operativas del personal no están disponibles mientras la cuenta esté inactiva.',updated:'Estado actualizado',checkAgain:'Revisar acceso de nuevo',account:'Cuenta y Seguridad',signOut:'Cerrar sesión'}:{verifyError:'Could not verify your staff access.',checking:'Checking staff access…',staff:'El Molino Staff',title:'Account Access',suspended:'Access suspended',inactive:'Account inactive',suspendedHeading:'Your staff access is temporarily suspended.',inactiveHeading:'Your staff account is not active.',questions:'Please speak with a manager if you have questions about your current employment status.',meaning:'What this means',suspendedBody:'Your employee profile and history remain intact, but scheduling, Shift Pool, team, time-clock, training and tip tools are unavailable until management restores access.',inactiveBody:'Your employee profile remains linked for recordkeeping, but operational staff tools are unavailable while the account is inactive.',updated:'Status updated',checkAgain:'Check access again',account:'Account & Security',signOut:'Sign out'};
