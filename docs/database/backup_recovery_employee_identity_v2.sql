-- Applied to production Supabase as migration: backup_recovery_employee_identity_v2
-- Extends transactional recovery to the employee lifecycle and role-verification audit tables.
